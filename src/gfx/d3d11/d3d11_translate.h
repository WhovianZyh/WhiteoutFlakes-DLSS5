...
inline D3D11_FILTER ToD3D11Filter(Filter minF, Filter magF, u32 maxAnisotropy = 1) {
    if (maxAnisotropy > 1)
...
inline D3D11_FILTER ToD3D11FilterComparison(Filter minF, Filter magF, u32 maxAnisotropy = 1) {
    if (maxAnisotropy > 1)
