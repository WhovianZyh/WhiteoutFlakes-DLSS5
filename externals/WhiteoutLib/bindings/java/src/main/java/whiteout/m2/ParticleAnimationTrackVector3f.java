...
/**
 * Java binding for the native ParticleAnimationTrack<whiteout::Vector3f> type.
 *
 * <p><b>Lifecycle.</b> Instances hold a handle to a native
 * ParticleAnimationTrack<whiteout::Vector3f> allocation. Always release them with
 * {@link #close()} — try-with-resources is the natural shape:
 * <pre>{@code
 * try (ParticleAnimationTrackVector3f obj = ...) {
 *     // ... use obj ...
 * }
 * }</pre>
 ...
 */
public final class ParticleAnimationTrackVector3f implements AutoCloseable {
    final MemorySegment handle;
    final boolean owned;

    ParticleAnimationTrackVector3f(MemorySegment seg, boolean owned) {
        this.handle = seg;
        this.owned = owned;
    }
