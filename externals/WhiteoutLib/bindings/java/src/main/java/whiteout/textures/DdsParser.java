 ...
 */
public final class DdsParser implements AutoCloseable {
    private static final long BYTES = 16L;

    final MemorySegment handle;
    final boolean owned;

    DdsParser(MemorySegment seg, boolean owned) {
    ...
    public DdsParser() {
        MemorySegment __raw = (MemorySegment) NativeCommon.invokeNative(Native.whiteout_textures_DdsParser_new);
    ...
    public void close() {
        ...
        if (handle != null && !handle.equals(MemorySegment.NULL)) {
            NativeCommon.invokeNative(Native.whiteout_textures_DdsParser_delete, handle);
        }
    }
    ...
    public java.util.Optional<Texture> parse(byte[] buffer) {
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment __h = (MemorySegment) NativeCommon.invokeNative(Native.whiteout_textures_DdsParser_parse, handle, buffer_seg, (long) buffer.length);
    ...
    public boolean hasIssues() {
        return ((int) NativeCommon.invokeNative(Native.whiteout_textures_DdsParser_hasIssues, handle)) != 0;
    }
    ...
    public java.util.List<String> getIssues() {
        try (Arena arena = Arena.ofConfined()) {
            long __n = (long) NativeCommon.invokeNative(Native.whiteout_textures_DdsParser_getIssues_count, handle);
            var __out = new java.util.ArrayList<String>((int) __n);
            for (long __i = 0; __i < __n; __i++) {
                MemorySegment __s = (MemorySegment) NativeCommon.invokeNative(Native.whiteout_textures_DdsParser_getIssues_at, arena, handle, __i);
    ...
    @Override public String toString() {
        return "DdsParser@" + Long.toHexString(handle == null ? 0 : handle.address());
    }
