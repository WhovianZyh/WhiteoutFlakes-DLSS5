 ...
 */
public final class DdsWriter implements AutoCloseable {
    private static final long BYTES = 16L;

    final MemorySegment handle;
    final boolean owned;

    DdsWriter(MemorySegment seg, boolean owned) {
    ...
    public DdsWriter() {
        MemorySegment __raw = (MemorySegment) NativeCommon.invokeNative(Native.whiteout_textures_DdsWriter_new);
    ...
    public void close() {
        ...
        if (handle != null && !handle.equals(MemorySegment.NULL)) {
            NativeCommon.invokeNative(Native.whiteout_textures_DdsWriter_delete, handle);
        }
    }
    ...
    public byte[] write(Texture texture) {
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment __struct = (MemorySegment) NativeCommon.invokeNative(Native.whiteout_textures_DdsWriter_write, arena, handle, texture == null ? MemorySegment.NULL : texture.handle);
    ...
    public boolean hasIssues() {
        return ((int) NativeCommon.invokeNative(Native.whiteout_textures_DdsWriter_hasIssues, handle)) != 0;
    }
    ...
    public java.util.List<String> getIssues() {
        try (Arena arena = Arena.ofConfined()) {
            long __n = (long) NativeCommon.invokeNative(Native.whiteout_textures_DdsWriter_getIssues_count, handle);
            var __out = new java.util.ArrayList<String>((int) __n);
            for (long __i = 0; __i < __n; __i++) {
                MemorySegment __s = (MemorySegment) NativeCommon.invokeNative(Native.whiteout_textures_DdsWriter_getIssues_at, arena, handle, __i);
    ...
    @Override public String toString() {
        return "DdsWriter@" + Long.toHexString(handle == null ? 0 : handle.address());
    }
