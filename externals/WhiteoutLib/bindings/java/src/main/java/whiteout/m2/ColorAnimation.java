...
/**
 * Java binding for the native ColorAnimation type.
 *
 * <p><b>Lifecycle.</b> Instances hold a handle to a native
 * ColorAnimation allocation. Always release them with
 * {@link #close()} — try-with-resources is the natural shape:
 * <pre>{@code
 * try (ColorAnimation obj = ...) {
 *     // ... use obj ...
 * }
 * }</pre>
 ...
 */
public final class ColorAnimation implements AutoCloseable {
    private static final long BYTES = 208L;

    final MemorySegment handle;
    final boolean owned;

    ColorAnimation(MemorySegment seg, boolean owned) {
