 ...
 */
public final class BmpWriter implements AutoCloseable {
    private static final long BYTES = 16L;

    final MemorySegment handle;
    final boolean owned;

    BmpWriter(MemorySegment seg, boolean owned) {
    ...
    public BmpWriter() {
        MemorySegment __raw = (MemorySegment) NativeCommon.invokeNative(Native.whiteout_textures_BmpWriter_new);
    ...
    public void close() {
        ...
        if (handle != null && !handle.equals(MemorySegment.NULL)) {
            NativeCommon.invokeNative(Native.whiteout_textures_BmpWriter_delete, handle);
        }
    }
    ...
    public byte[] write(Texture texture) {
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment __struct = (MemorySegment) NativeCommon.invokeNative(Native.whiteout_textures_BmpWriter_write, arena, handle, texture == null ? MemorySegment.NULL : texture.handle);
    ...
    public boolean hasIssues() {
        return ((int) NativeCommon.invokeNative(Native.whiteout_textures_BmpWriter_hasIssues, handle)) != 0;
    }
    ...
    public java.util.List<String> getIssues() {
        try (Arena arena = Arena.ofConfined()) {
            long __n = (long) NativeCommon.invokeNative(Native.whiteout_textures_BmpWriter_getIssues_count, handle);
            var __out = new java.util.ArrayList<String>((int) __n);
            for (long __i = 0; __i < __n; __i++) {
                MemorySegment __s = (MemorySegment) NativeCommon.invokeNative(Native.whiteout_textures_BmpWriter_getIssues_at, arena, handle, __i);
    ...
    @Override public String toString() {
        return "BmpWriter@" + Long.toHexString(handle == null ? 0 : handle.address());
    }
