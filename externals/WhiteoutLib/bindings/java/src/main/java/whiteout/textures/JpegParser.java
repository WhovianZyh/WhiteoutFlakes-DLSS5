 ...
 */
public final class JpegParser implements AutoCloseable {
    private static final long BYTES = 16L;

    final MemorySegment handle;
    final boolean owned;

    JpegParser(MemorySegment seg, boolean owned) {
    ...
    public java.util.List<String> getIssues() {
        try (Arena arena = Arena.ofConfined()) {
            long __n = (long) NativeCommon.invokeNative(Native.whiteout_textures_JpegParser_getIssues_count, handle);
            var __out = new java.util.ArrayList<String>((int) __n);
            for (long __i = 0; __i < __n; __i++) {
                MemorySegment __s = (MemorySegment) NativeCommon.invokeNative(Native.whiteout_textures_JpegParser_getIssues_at, arena, handle, __i);
    ...
    @Override public String toString() {
        return "JpegParser@" + Long.toHexString(handle == null ? 0 : handle.address());
    }
