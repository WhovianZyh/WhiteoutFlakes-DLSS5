...
/// JPEG-specific Huffman codec facade.
///
/// The underlying bit I/O and Huffman table primitives now live in
/// src/whiteout/common/{bit_io.h, huffman_table.h}. This header re-exports
/// them under the original JPEG-local names for backward compatibility and
/// adds the standard JPEG Huffman table data (ITU-T T.81 Annex K).
...
// Unified bit I/O and Huffman table primitives.
